...
* Intermediate values are automatically cached for fast iteration during exploration of
  data and analysis development.
* Results and arguments of all nodes in the graph are retrievable from the root node.
* The graph is cloneable and mutable allowing easy re-computation of the graph with
  modified function arguments.

"""

from fungraph import _version, error
from fungraph.cache import Cache, cachecontext
